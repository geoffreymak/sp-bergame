...
function TableauCorDialog(props) {
  ...
  return (
    ...
    >
      <DialogTitle style={{ cursor: 'move' }} id="draggable-dialog-title">
        IMPRESSION DU TABLEAU DE CORRESPONDANCE DES DIFFERENTES RUBRIQUES DES
        ...
        <Button
          onClick={() => {
            ...
            const printData = {
              type,
              title:
                "TABLEAU DE CORRESPONDANCE DES DIFFERENTES RUBRIQUES DES NOTES ANNEXES AUX ETATS FINANCIERS DE L'ANNEE N",
              date: {
                fromDate: null,
...
TableauCorDialog.propTypes = {
  open: PropTypes.bool,
  onClose: PropTypes.func,
  type: PropTypes.string
};

export default TableauCorDialog;
