...
const icon = url.format(
  path.join(__dirname, '/..', '/..', '/images', '/icons', '/cvm.png')
);
...
const createTable = (data) => {
  return `
    <thead>
      <tr class="no-border">
        <th style="background-color: white" class="no-border">CODE</th>
        <th style="background-color: white" class="no-border">LIBELLE</th>    
      </tr>    
    </thead>
    <tbody>
