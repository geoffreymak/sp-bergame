...
const createRow = (data, compte) => {
  return `
    <tr class="no-border">
      <td class="">${moment(data.date).format('DD/MM/yyyy')}</td>
      <td class="">${data?.piece}</td>
      <td class="">${formatNumber(data?.parite)}</td>
      <td class="">${formatNumber(data?.taux)}</td>
       <td class="">${data?.libelle}</td>
       <td class="">${data?.imputation}</td>
      <td class="text-right">
        ${
  ...
  return `
    <table>
      <thead>
        ...
        <tr>
          <th style="background-color: white" class="text-center">Date</th>
          <th style="background-color: white" class="text-center">Piéce</th>
          <th style="background-color: white" class="text-center">Parité</th>
          <th style="background-color: white" class="text-center">Taux</th>
          <th style="background-color: white" class="text-center">Libéllé</th>
          <th style="background-color: white" class="text-center">Code</th>
      ...
      <tbody>
        ${data.map((d) => createRow(d, compte)).join('')}
...
const createTable = ({ report, compte, data }) => {
  return groupByMouthWithReport(data)
