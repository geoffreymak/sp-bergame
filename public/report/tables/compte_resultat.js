...
const createRow = (data) => {
  ...
  return `
    <tr class="">
      ...
      <td class="text-center">${data.signe ? data.signe : ''}</td>
      <td class="text-center text-bold">${data.note ? data.note : ''}</td>

      ${data.sum ? `<th class='text-right'>` : `<td class='text-right'>`}
      ${solde1 ? formatNumber(solde1, true) : 0}
      ${data.sum ? `</th>` : `</td>`}

      ${data.sum ? `<th class='text-right'>` : `<td class='text-right'>`}
       ${solde2 ? formatNumber(solde2, true) : 0}
      ${data.sum ? `</th>` : `</td>`}
  ...
  return `
    <thead>
      <tr class="">
        ...
        <th style="background-color: white" rowspan="2" class="text-center">LIBELLES</th>
        <th style="background-color: white" rowspan="2"></th>
        <th style="background-color: white" rowspan="2" class="text-center">NOTE</th>
        <th style="background-color: white" class="text-center">EXERCICE N</br>
